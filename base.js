// The following is copied and unminified from https://cdn.knightlab.com/libs/timeline3/latest/js/timeline.js by Yi Heng. 
...
(() => {
                    ...
                    return (function t() {
                        ...
                        var _t = z,
                            ...
                            Vt = function (t) {
                                (Zt && Zt === t) ||
                                    ...
                                    (Wt = "ADD_URI_SAFE_ATTR" in t ? x(T(Gt), t.ADD_URI_SAFE_ATTR) : Gt),
                                    ...
                                    Ft &&
                                        ...
                                        !0 === Ft.mathMl && (x(wt, N), x(xt, O), x(xt, R))),
                        ...
                        var te = "http://www.w3.org/1998/Math/MathML",
                            ...
                            ce = function (t) {
                                ...
                                if (
                                    ...
                                    !he(t.firstElementChild) && (!he(t.content) || !he(t.content.firstElementChild)) && b(/<[/\w]/g, t.innerHTML) && b(/<[/\w]/g, t.textContent))
                                )
                                    return se(t), !0;
                                if (!wt[a] || Mt[a]) {
                                    if (Ht && !$t[a]) {
                                        var s = it(t),
                                            n = et(t);
                                        if (n && s) for (var o = n.length - 1; o >= 0; --o) s.insertBefore(Q(n[o], !0), tt(t));
                                    }
                                    return se(t), !0;
                                }
                                return t instanceof h && !ae(t)
                                    ...
                                    ? (Nt && 3 === t.nodeType && ((e = t.textContent), (e = g(e, _t, " ")), (e = g(e, pt, " ")), t.textContent !== e && (_(i.removed, { element: t.cloneNode() }), (t.textContent = e))),
                        ...
                        return (
                            (i.sanitize = function (t, s) {
                                ...
                                if (jt) {
                                    if (Ot) for (c = dt.call(n.ownerDocument); n.firstChild; ) c.appendChild(n.firstChild);
                                    else c = n;
                                    ...
                                    t(s, [
                                        {
                                            ...
                                            value: function (t, e) {
                                                if (e) {
                                                    ...
                                                    var i = new n(t, this);
                                                    if ((t.setAttribute("inert", ""), this._inertRoots.set(t, i), !this._document.body.contains(t))) for (var a = t.parentNode; a; ) 11 === a.nodeType && d(a), (a = a.parentNode);
                                                } else {
                                                    if (!this._inertRoots.has(t)) return;
    ...
    (() => {
        "use strict";
        i.r(a), i.d(a, { Timeline: () => Xe, lookupMediaType: () => $e, parseGoogleSpreadsheetURL: () => te });
        ...
        function L(t) {
            E[t.toLowerCase()] && (t = E[t.toLowerCase()]),
        ...
        let Y =
            ((J = (V = "123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ").length),
            {
                encode: function (t) {
        ...
        st.extend = function (t) {
            ...
            return (
                t.statics && (S(e, t.statics), delete t.statics),
                t.includes && (S.apply(null, [a].concat(t.includes)), delete t.includes),
                t.options && a.options && (t.options = S({}, a.options, t.options)),
                S(a, t),
                (e.extend = st.extend),
        ...
        class nt {
            ...
            removeEventListener(t, e, i) {
                ...
                for (var a = 0, s = this._tl_events, n = s[t].length; a < n; a++) if (s[t][a].action === e && (!i || s[t][a].context === i)) return s[t].splice(a, 1), this;
                return this;
            }
            off(t, e, i) {
            ...
            fire(t, e) {
                if (!this.hasEventListeners(t)) return this;
                for (var i = D({ type: t, target: this }, e), a = this._tl_events[t].slice(), s = 0, n = a.length; s < n; s++) a[s].action ? a[s].action.call(a[s].context || this, i) : A(`no action defined for ${t} listener`);
                return this;
            }
        }
        function ot(t, e) {
        ...
        const rt = (function () {
            ...
            function S(t, e) {
                ...
                for (a = 1; a < s; ++a) for (i = 0; i < s - a; ++i) (n[i][0] = (1 - e) * n[i][0] + e * n[parseInt(i + 1, 10)][0]), (n[i][1] = (1 - e) * n[i][1] + e * n[parseInt(i + 1, 10)][1]);
                return [n[0][0], n[0][1]];
            }
            ...
            function I(t, e) {
                ...
                for (c && ((a = e.left), (s = e.top), delete e.right, delete e.bottom, delete e.left, delete e.top), i = n.length; i--; ) {
                    ...
                    for (var L in e) {
                        ...
                        "string" != typeof j || !l.test(j) || l.test(C)
                            ? ((u[i][L] = "transform" == L ? k(C) : "string" == typeof j && l.test(j) ? T(C).slice(1) : parseFloat(C)),
                              (m[i][L] = "transform" == L ? k(j, u[i][L]) : "string" == typeof j && "#" == j.charAt(0) ? T(j).slice(1) : A(j, parseFloat(C))),
                ...
                return D.apply(n, [
                    ...
                    function (t, a, s) {
                        for (i = n.length; i--; )
                            for (var o in (c && ((s = S(p[i], t)), (n[i].style.left = s[0] + "px"), (n[i].style.top = s[1] + "px")), e))
                                (a = N(t, _, u, m, o, i)), "transform" == o ? (n[i].style[f] = x(a)) : "opacity" != o || g ? (n[i].style[M(o)] = a) : (n[i].style.filter = "alpha(opacity=" + 100 * a + ")");
                    },
                    o,
                    h,
                ]);
        ...
        class ht {
            constructor(t, e, i) {
                (this._el = { drag: t, move: t }),
                    ...
                    i && (this._el.move = i),
                    (this.options = { enable: { x: !0, y: !0 }, constraint: { top: !1, bottom: !1, left: !1, right: !1 }, momentum_multiplier: 2e3, duration: 1e3, ease: at }),
                    (this.animator = null),
            ...
            _onDragStart(t) {
                f
                    ...
                    ct.addListener(this._el.drag, this.dragevent.move, this._onDragMove, this),
                    ct.addListener(this._el.drag, this.dragevent.leave, this._onDragEnd, this);
            }
            _onDragEnd(t) {
                (this.data.sliding = !1),
                    ct.removeListener(this._el.drag, this.dragevent.move, this._onDragMove, this),
                    ct.removeListener(this._el.drag, this.dragevent.leave, this._onDragEnd, this),
            ...
            _animateMomentum() {
                var t = { x: this.data.new_pos.x, y: this.data.new_pos.y },
                    e = { duration: this.options.duration, easing: it };
                this.options.enable.y &&
                    ...
                    (this.animator = ot(this._el.move, e)),
                            ...
                            return this.each(function () {
                                ...
                                "none" == this.style.display && (this.style.display = ""),
                                    "none" == getComputedStyle(this, "").getPropertyValue("display") &&
                                        (this.style.display =
                                            ((t = this.nodeName),
                                            d[t] || ((e = h.createElement(t)), h.body.appendChild(e), (i = getComputedStyle(e, "").getPropertyValue("display")), e.parentNode.removeChild(e), "none" == i && (i = "block"), (d[t] = i)),
                                            d[t]));
                            });
                        },
        ...
        (window.Zepto = ut),
                                  ...
                                  h &&
                                      ...
                                      o &&
                                          (c = function (e) {
                                              ...
                                              if (n && n !== s) return (i = t.extend(x(e), { currentTarget: n, liveFired: s })), (d || l).apply(n, [i].concat(a.call(arguments, 1)));
                                          }),
                                      f(s, i, l, r, o, c || d);
                              }));
                    }),
            ...
            (function (t) {
                ...
                (t.active = 0),
                    ...
                    (t.ajaxSettings = {
                        ...
                        accepts: { script: "text/javascript, application/javascript, application/x-javascript", json: l, xml: "application/xml, text/xml", html: h, text: "text/plain" },
                        crossDomain: !1,
                        timeout: 0,
                        processData: !0,
                        cache: !0,
            ...
            ((dt = ut).fn.serializeArray = function () {
                var t,
                    e = [];
                return (
                    dt([].slice.call(this.get(0).elements)).each(function () {
        ...
        const mt = ut.getJSON,
            ...
            wt = st.extend({
                ...
                floor: function (t) {
                    for (var e = new Date(this.data.date_obj.getTime()), i = 0; i < ft.length; i++) if ((ft[i][2](e), ft[i][0] == t)) return new wt(e);
                ...
                findBestFormat: function (t) {
                    for (var e = gt, i = 0; i < e.length; i++) if (this.data[e[i]]) return t ? t in bt || (t = "short") : (t = "base"), bt[t][e[i]];
                    return "";
                },
        ...
        const St = [
            ...
            Nt = wt.extend({
                initialize: function (t, e, i) {
                    xt == t.constructor ? (this.data = { date_obj: t }) : ((this.data = JSON.parse(JSON.stringify(t))), this._createDateObj()), t.format && !e && (e = t.format), this._setFormat(e, i);
                },
                _createDateObj: function () {
                    var t = this._getDateData();
        ...
        class It {
            ...
            formatDate(t, e) {
                return t.constructor == Date
                    ...
                    : (A("Unfamiliar date presented for formatting"), t.toString());
            }
            formatJSDate(t, e) {
                var i = this,
                    a = function (t, e) {
        ...
        (It.fallback = { messages: {} }), (It.DATE_FORMAT_TOKENS = /d{1,4}|m{1,4}|yy(?:yy)?|([HhMsTt])\1?|[LloSZ]|"[^"]*"|'[^']*'/g);
        var Ot = {
            en: {
        ...
        function qt(t) {
            ...
            if (((e.hour = parseInt(o)), i && "p" == i.toLowerCase()[0] && 12 != e.hour ? (e.hour += 12) : i && "a" == i.toLowerCase()[0] && 12 == e.hour && (e.hour = 0), isNaN(e.hour) || e.hour < 0 || e.hour > 23))
                throw new M("invalid_hour_err", o);
            if (s.length > 1) {
                let t = s[1];
        ...
        const Bt = { human: wt, cosmological: Nt };
        var Ut = i(856),
            Wt = i.n(Ut);
        const Gt = { text: ["headline", "text"], media: ["caption", "credit"] },
        ...
        function Vt(t) {
            return Wt().sanitize(t, { ADD_TAGS: ["iframe"], ADD_ATTR: ["frameborder", "target"] });
        }
        ...
        class Jt {
            ...
            _assignID(t) {
                var e = t.unique_id;
                return (
                    R(e) || (e = t.text ? P(t.text.headline) : null),
                        ...
                        if (
                            ...
                            let e = (function (t) {
                                ...
                                if (Object.keys(e).includes("Start Date") || Object.keys(e).includes("End Date")) e["Start Date"] && (a.start_date = kt(e["Start Date"])), e["End Date"] && (a.end_date = kt(e["End Date"]));
                                    ...
                                    if (
                                        (e.Year && (a.start_date = { year: Qt(e.Year), month: Qt(e.Month) || "", day: Qt(e.Day) || "" }),
                                        e["End Year"] && (a.end_date = { year: Qt(e["End Year"]) || "", month: Qt(e["End Month"]) || "", day: Qt(e["End Day"]) || "" }),
                                        e.Time)
                                    ) {
        ...
        var ae = {},
            se = function (t, e) {
                ...
                for (var i = 0; i < e.length - 1; i++) {
                    var a = e[i],
                        s = e[i + 1];
                    ae[t].push(new ie({ scale: a[3], minor: { name: a[0], factor: a[1] }, major: { name: s[0], factor: s[1] } }));
                }
            };
        ...
        class oe {
            constructor(t, e) {
                var i = t.events;
                (this._scale = t.scale),
                    (e = D({ display_width: 500, screen_multiplier: 3, max_rows: null }, e)),
            ...
            _computePositionInfo(t, e, i) {
                ...
                if (a.length) {
                    ...
                    for (var _ = 0; n < l.length; n++) {
                        for (this._group_labels.push({ label: l[n].label, rows: l[n].n_rows }), h = 0; h < l[n].positions.length; h++) (o = l[n].positions[h]).row += _;
                        _ += l[n].n_rows;
                    }
                } else {
        ...
        class le {
            constructor(t, e, i, a) {
                (this.start_date = t),
                    ...
                    (this.options = { duration: 1e3, ease: et, width: 600, height: 600, marker_width_min: 100 }),
                    (this.active = !1),
                    (this.animator = {}),
                    (this.has_end_date = !1),
                    D(this.options, a),
            ...
            setRowPosition(t, e) {
                this.setPosition({ top: t }), e < 56 && T(this._el.content_container, "tl-timeera-content-container-small");
            }
            setColor(t) {
            ...
            _initLayout() {
                (this._el.container = v("div", "tl-timeera")),
                    ...
                    this.headline && "" != this.headline && (this._text.innerHTML = $(this.headline)),
                    this.onLoaded();
            }
            _initEvents() {}
            _updateDisplay(t, e, i) {
        ...
        class he {
            constructor(t, e, i) {
                i && this.setLanguage(i),
                    ...
                    (this._state = { loaded: !1 }),
                    (this.data = {}),
                    (this.options = { duration: 1e3, ease: et, width: 600, height: 600 }),
                    (this.active = !1),
                    (this.animator = {}),
                    (this.axis_helper = {}),
                    (this.minor_ticks = []),
        ...
        class de {
            ...
            _initLayout() {
                ...
                if (((this._el.date = v("h3", "tl-headline-date", this._el.headline_container)), "" != this.data.text)) {
                    var e = "";
                    (e += (i = 1 == this.options.autolink ? U(this.data.text) : this.data.text).match(/<p>[\s\S]*?<\/p>/) ? i : "<p>" + i + "</p>"),
        ...
        class ce {
            constructor(t, e, i) {
                i && this.setLanguage(i),
                    ...
                    D(this.options, e),
                    D(this.data, t),
                    this.options.background || ((this._el.container = v("div", "tl-media")), this.data.unique_id && (this._el.container.id = this.data.unique_id), this._initLayout());
            }
            loadMedia() {
                var t = this;
            ...
            updateMediaDisplay(t) {
                this._state.loaded &&
                    ...
                    ((this._el.content_item.style.maxHeight = h ? this.options.height / 2 + "px" : this.options.height - this.options.credit_height - this.options.caption_height - 30 + "px"),
            ...
            showMeta(t, e) {
                (this._state.show_meta = !0),
                    this.data.credit &&
                        ...
                        (this._el.credit.innerHTML = 1 == this.options.autolink ? U(this.data.credit) : this.data.credit),
                        (this.options.credit_height = this._el.credit.offsetHeight)),
                    this.data.caption &&
                        "" != this.data.caption &&
                        ((this._el.caption = v("div", "tl-caption", this._el.content_container)),
                        (this._el.caption.innerHTML = 1 == this.options.autolink ? U(this.data.caption) : this.data.caption),
            ...
            updateMeta() {
                !this.data.credit &&
                    ...
                    ((this._el.credit = v("div", "tl-credit", this._el.content_container)), (this._el.credit.innerHTML = this.data.credit_alternate), (this.options.credit_height = this._el.credit.offsetHeight)),
                    !this.data.caption &&
                        this.data.caption_alternate &&
                        ((this._el.caption = v("div", "tl-caption", this._el.content_container)), (this._el.caption.innerHTML = this.data.caption_alternate), (this.options.caption_height = this._el.caption.offsetHeight)),
                    this.updateDisplay();
            }
            onAdd() {
                this.fire("added", this.data);
            ...
            _initLayout() {
                (this.message = new Pt(this._el.container, this.options, this.getLanguage())),
        ...
        class ue extends ce {
            ...
            createMedia() {
                ...
                (this.data.url.match(/.png(\?.*)?$/) || this.data.url.match(/.svg(\?.*)?$/)) && (e = "tl-media-item tl-media-image"),
                    ...
                    this.data.alt ? (this._el.content_item.alt = this.data.alt) : this.data.caption && (this._el.content_item.alt = B(this.data.caption)),
                    this.data.title ? (this._el.content_item.title = this.data.title) : this.data.caption && (this._el.content_item.title = B(this.data.caption)),
        ...
        let pe = new (class {
            ...
            load(t, e, i, a, s) {
                var n,
                    ...
                    m = [];
                if (e)
                    if (((e = "string" == typeof e ? [e] : e.concat()), u || this.env.async || this.env.gecko || this.env.opera)) this.queue[t].push({ urls: e, callback: i, obj: a, context: s });
                ...
                if (!this.pending[t] && (l = this.pending[t] = this.queue[t].shift())) {
                    for (n = 0, o = (h = l.urls).length; n < o; ++n)
                        (d = h[n]),
                            u ? (r = this.env.gecko ? this.createNode("style") : this.createNode("link", { href: d, rel: "stylesheet" })) : ((r = this.createNode("script", { src: d })).async = !1),
        ...
        class fe extends ce {
            _loadMedia() {
                ...
                (this.youtube_loaded = !1),
                    ...
                    this.data.url.match("v=")
                        ...
                        : A("YOUTUBE IN URL BUT NOT A VALID VIDEO"),
                    this.data.url.match("start=") ? (this.media_id.start = X(this.data.url.split("start=")[1])) : this.data.url.match("t=") && (this.media_id.start = X(this.data.url.split("t=")[1])),
                    this.data.url.match("end=") && (this.media_id.end = X(this.data.url.split("end=")[1])),
            ...
            _updateMediaDisplay() {
                (this._el.content_item.style.height = Z({ w: this.options.width }) + "px"), (this._el.content_item.style.width = this.options.width + "px");
            }
            _stopMedia() {
        ...
        class ge extends ce {
            ...
            _updateMediaDisplay() {
                if (this._state.loaded) {
                    var t = G({ w: this._el.content_item.offsetWidth });
                    this._el.content_item.style.height = t.h + "px";
                }
            }
            makeGoogleMapsEmbedURL(t, e) {
                var i = !1,
                    a = { view: ["center"], place: ["q", "center"], directions: ["origin", "destination", "center"], search: ["q", "center"], streetview: ["fov", "heading", "pitch"] },
                    s = /(https:\/\/.+google.+?\/maps)/,
                    n = /@([-\d.]+),([-\d.]+)/,
                    o = /([\w\W]+)/,
                    r = /,((?:[-\d.]+[zmayht],?)*)/,
                ...
                try {
                    this.establishMediaID(),
                        ...
                        mt(t, function (t) {
                            ...
                            e.url
                                ? ((a.base_image_url = e.url), (a.page_id = e.page_id), !a.data.alt && e.label && (a.data.alt = e.label), a.options.background || a.createMedia(), a.onLoaded())
                    ...
                    pt(`https://commons.wikimedia.org/w/api.php?action=wbgetentities&format=json&ids=${e}&format=json&origin=*`).then((i) => {
                        if (i.entities && i.entities[e]) {
                            ...
                            a[s] ? (n = a[s]) : s.length > 2 && a[s.substr(0, 2)] ? (n = a[s.substr(0, 2)]) : a.en && (n = a.en),
                                n ? (console.log(`wikibase_id: ${t.media_id} alt ${n.value}`), (t.data.alt = n.value), (t._el.content_item.alt = t.data.alt)) : console.log(`wikibase_id: ${t.media_id} ain't got no alt`);
                        }
                    });
                }
        ...
        class ke extends ce {
            ...
            _updateMediaDisplay() {
                this._el.content_item.style.height = Z({ w: this._el.content_item.offsetWidth }) + "px";
            }
            _stopMedia() {
                try {
                    this.player && this.player.contentWindow && this.player.contentWindow.postMessage(JSON.stringify({ method: "pause" }), "https://player.vimeo.com");
                } catch (t) {
                    A(t);
                }
            }
        ...
        class xe extends ce {
            ...
            _updateMediaDisplay() {
                this._state.loaded && (this._el.content_item.style.height = Z({ w: this._el.content_item.offsetWidth }) + "px");
            }
            _stopMedia() {
        ...
        class Te extends ce {
            ...
            _updateMediaDisplay() {
                var t = G({ w: this._el.content_item.offsetWidth, h: this.options.height });
                this._el.content_item.style.height = t.h + "px";
            }
            _stopMedia() {
        ...
        class Me extends ce {
            ...
            createMedia(t) {
                ...
                (n = t.html.split("</p>&mdash;")[0] + "</p></blockquote>"),
                    ...
                    (n = n.replace(/<a href/gi, '<a target="_blank" rel="noopener" href')).includes("pic.twitter.com")
        ...
        class De extends ce {
            _loadMedia() {
                ...
                (this._el.content_item = this.domCreate("div", "tl-media-item tl-media-documentcloud tl-media-shadow", this._el.content)),
                    (this._el.content_item.id = H(7)),
                    this.data.url.match(/\.html$/) ? (this.data.url = this._transformURL(this.data.url)) : this.data.url.match(/.(json|js)$/) || A("DOCUMENT CLOUD IN URL BUT INVALID SUFFIX"),
        ...
        class Ie extends ce {
            ...
            createMedia() {
                ...
                try {
                    _t({ url: t, dataType: "json", success: Ne, error: Ae, context: this });
                } catch (e) {
        ...
        class Oe extends ce {
            ...
            _updateMediaDisplay(t) {
                ...
                (e = h ? this.options.height / 2 : this.options.height - this.options.credit_height - this.options.caption_height - 30),
                    ...
                    e > this.options.width ? (A("height is greater"), (i = this.options.width + 80 + "px"), (a = this.options.width + "px")) : (A("width is greater"), A(this.options.width), (i = e + "px"), (a = e - 80 + "px")),
        ...
        class Re extends ce {
            constructor(t, e, i) {
                super(t, e, i), (this.iframe = Wt().sanitize(this.data.url, { ADD_TAGS: ["iframe"], ADD_ATTR: ["frameborder"] }));
            }
            _loadMedia() {
        ...
        class ze extends ce {
            ...
            _updateMediaDisplay() {
                (this._el.content_item.style.width = this.options.width + "px"), (this._el.content_item.style.height = Z({ w: this.options.width }) + "px");
            }
        }
        class Pe extends ce {
            _loadMedia() {
        ...
        class Fe extends ce {
            _loadMedia() {
                ...
                (this._el.content_item = this.domCreate("div", "tl-media-item tl-media-iframe tl-media-wistia tl-media-shadow", this._el.content)),
                    ...
                    A(`Wistia: media_id: ${this.media_id}`),
        ...
        function $e(t, e) {
            var i = [
                { type: "youtube", name: "YouTube", match_str: "^(https?:)?/*(www.|m.)?youtube|youtu.be", cls: fe },
                { type: "vimeo", name: "Vimeo", match_str: "^(https?:)?/*(player.)?vimeo.com", cls: ke },
                { type: "dailymotion", name: "DailyMotion", match_str: "^(https?:)?/*(www.)?(dailymotion.com|dai.ly)", cls: xe },
                { type: "vine", name: "Vine", match_str: "^(https?:)?/*(www.)?vine.co", cls: Te },
                { type: "soundcloud", name: "SoundCloud", match_str: "^(https?:)?/*(player.)?soundcloud.com", cls: we },
                ...
                { type: "profile", name: "Profile", match_str: /^(https?:)?\/*(www.)?instagr.am\/[a-zA-Z0-9]{2,}|^(https?:)?\/*(www.)?instagram.com\/[a-zA-Z0-9]{2,}/, cls: Ce },
                { type: "documentcloud", name: "Document Cloud", match_str: /documentcloud.org\//, cls: De },
                { type: "wikipedia-image", name: "WikipediaImage", match_str: "^https://.+.wiki[mp]edia.org.+#/media/.+.(jpg|jpeg|png|gif|svg|webp)", cls: be },
                { type: "wikipedia-image", name: "WikipediaImage", match_str: "^https://commons.wikimedia.org/wiki/File:.+.(jpg|jpeg|png|gif|svg|webp)", cls: be },
                { type: "wikipedia", name: "Wikipedia", match_str: "^(https?:)?/.+.wikipedia.org", cls: ye },
                { type: "image", name: "Image", match_str: /(jpg|jpeg|png|gif|svg|webp)(\?.*)?$/i, cls: ue },
                { type: "imgur", name: "Imgur", match_str: /^.*imgur.com\/.+$|<blockquote class=['\"]imgur-embed-pub['\"]/i, cls: ze },
                {
                    type: "googledocs",
                    name: "Google Doc",
                    match_str:
                ...
                { type: "blockquote", name: "Quote", match_str: "blockquote", cls: ve },
                { type: "video", name: "Video", match_str: /(mp4|webm)(\?.*)?$/i, cls: qe },
                { type: "wistia", name: "Wistia", match_str: /https?:\/\/(.+)?(wistia\.com|wi\.st)\/.*/i, cls: Fe },
                { type: "audio", name: "Audio", match_str: /(mp3|wav|m4a)(\?.*)?$/i, cls: He },
                { type: "imageblank", name: "Imageblank", match_str: "", cls: ue },
            ];
            if (e) {
        ...
        class Be {
            ...
            setHeight(t) {
                ...
                (this._el.content_container.style.height = t + "px"),
                    ...
                    t <= 56 ? x(this._el.content_container, "tl-timemarker-content-container-small") : T(this._el.content_container, "tl-timemarker-content-container-small"),
                    r
                        ? ((e = Math.floor(t / 14)) < 1 && (e = 1), (this._text.className = "tl-headline"), (this._text.style.webkitLineClamp = e))
                        : ((e = t / 12), (this._text.className = e > 1 ? "tl-headline tl-headline-fadeout" : "tl-headline"), (this._text.style.height = 12 * e + "px"));
            }
            ...
            _initLayout() {
                ...
                (this._el.text = v("div", "tl-timemarker-text", this._el.content)),
                    ...
                    this.data.text.headline && "" != this.data.text.headline
                        ...
                        : this.data.media && this.data.media.caption && "" != this.data.media.caption && (this._text.innerHTML = $(this.data.media.caption));
        ...
        class Ue {
            constructor(t, e, i) {
                (this._el = { drag: t, move: t }),
                    ...
                    (this.touchdrag = { down: "touchstart", up: "touchend", leave: "mouseleave", move: "touchmove" }),
                    e && (this._el.move = e),
                    (this.options = { snap: !1, enable: { x: !0, y: !0 }, constraint: { top: !1, bottom: !1, left: 0, right: !1 }, momentum_multiplier: 2e3, duration: 1e3, ease: at }),
                    (this.animator = null),
                    (this.dragevent = this.mousedrag),
                    f && (this.dragevent = this.touchdrag),
                    (this.data = {
            ...
            enable(t) {
                ct.addListener(this._el.drag, this.dragevent.down, this._onDragStart, this),
                    ct.addListener(this._el.drag, this.dragevent.up, this._onDragEnd, this),
            ...
            _momentum() {
                ...
                (this.data.direction = null),
                    ...
                    i.x && (Math.abs(e.x) > this._el.drag.offsetWidth / 2 && (a = !0), Math.abs(e.x) > 1e4 && ((this.data.direction = "left"), e.x > 0 && (this.data.direction = "right"))),
                    i.y && (Math.abs(e.y) > this._el.drag.offsetHeight / 2 && (a = !0), Math.abs(e.y) > 1e4 && ((this.data.direction = "up"), e.y > 0 && (this.data.direction = "down"))),
                    e.time < 1e3 || this._animateMomentum(),
                    a && this.data.direction
                        ? this.fire("swipe_" + this.data.direction, this.data)
                        : this.data.direction
                        ? this.fire("swipe_nodirection", this.data)
                        : this.options.snap && (this.animator.stop(), (this.animator = ot(this._el.move, { top: this.data.pos.start.y, left: this.data.pos.start.x, duration: this.options.duration, easing: it })));
            }
            _animateMomentum() {
                var t = { x: this.data.new_pos.x, y: this.data.new_pos.y },
                    e = { duration: this.options.duration, easing: it };
        ...
        class We {
            constructor(t, e, i, a) {
                (this.language = a),
                    (this._el = { parent: {}, container: {}, slider: {}, slider_background: {}, line: {}, marker_container_mask: {}, marker_container: {}, marker_item_container: {}, timeaxis: {}, timeaxis_background: {} }),
                    (this.collapsed = !1),
                    (this._el.container = "object" == typeof t ? t : g(t)),
            ...
            _getTimeScale() {
                ...
                return (
                    0 == t && (A("marker_height_min option must not be zero."), (t = 30)),
                    ...
                    new oe(this.config, { display_width: this._el.container.offsetWidth, screen_multiplier: this.options.scale_factor, max_rows: this.max_rows })
                );
            }
            _updateTimeScale(t) {
            ...
            _positionGroups() {
                if (this.options.has_groups)
                    for (
                        var t = this.options.height - this._el.timeaxis_background.offsetHeight, e = Math.floor(t / this.timescale.getNumberOfRows() - this.options.marker_padding), i = (this.timescale.getGroupLabels(), 0), a = 0;
                        ...
                        s > t - this.options.marker_padding && (n = !0),
                            ...
                            this._groups[i].setAlternateRowColor(q(i), n),
            ...
            focusOn(t, e, i) {
                ...
                this.animateMovement(n, e, i, s, a),
                    ...
                    t >= 0 && t < this._markers.length && (this._markers[t].setFocus(), (this.current_focused_id = this._markers[t].data.unique_id), this._markers[t].on("markerblur", this._onMarkerBlur, this));
            }
            focusNext() {
            ...
            animateMovement(t, e, i, a, s) {
                this.animator && this.animator.stop(),
                    e
                        ? ((this._el.slider.className = "tl-timenav-slider"), (this._el.slider.style.left = -this._markers[t].getLeft() + this.options.width / 2 + "px"))
                        : i
                        ? ((this._el.slider.className = "tl-timenav-slider tl-timenav-slider-animate"), (this.animate_css = !0), (this._el.slider.style.left = -this._markers[t].getLeft() + this.options.width / 2 + "px"))
                        : ((this._el.slider.className = "tl-timenav-slider"), (this.animator = ot(this._el.slider, { left: -this._markers[t].getLeft() + this.options.width / 2 + "px", duration: a, easing: s }))),
            ...
            _updateDrawTimeline(t) {
                var e = !1;
                if (t) {
                    var i = new oe(this.config, { display_width: this._el.container.offsetWidth, screen_multiplier: this.options.scale_factor, max_rows: this.max_rows });
            ...
            _initLayout() {
                (this._el.line = v("div", "tl-timenav-line", this._el.container)),
                    ...
                    (this.timeaxis = new he(this._el.timeaxis, this.options, this.language)),
                    (this._swipable = new Ue(this._el.slider_background, this._el.slider, { enable: { x: !0, y: !1 }, constraint: { top: !1, bottom: !1, left: this.options.width / 2, right: !1 }, snap: !1 })),
                    this._swipable.enable();
            }
            _initEvents() {
                this._swipable.on("dragmove", this._onDragMove, this),
                    ct.addListener(this._el.container, "mousewheel", this._onMouseScroll, this),
                    ct.addListener(this._el.container, "DOMMouseScroll", this._onMouseScroll, this),
                    ct.addListener(this._el.container, "keydown", this._onKeydown, this);
            }
            _initData() {
        ...
        class Ge {
            constructor(t, e, i, a) {
                a && this.setLanguage(a),
                    ...
                    (this.options = { duration: 1e3, slide_padding_lr: 40, ease: et, width: 600, height: 600, skinny_size: 650, media_name: "" }),
                    (this.active = !1),
                    (this.animator = {}),
                    D(this.options, e),
                    D(this.data, t),
            ...
            show() {
                this.animator = ot(this._el.slider_container, { left: -this._el.container.offsetWidth * n + "px", duration: this.options.duration, easing: this.options.ease });
            }
            hide() {}
            setActive(t) {
            ...
            _initLayout() {
                if (
                    ...
                    if (this.data.background.url) {
                        ...
                        t &&
                            ...
                            this.data.background.alt && (this._el.background.setAttribute("role", "img"), this._el.background.setAttribute("aria-label", this.data.background.alt));
                    }
                ...
                this.data.media && this.data.media.url && "" != this.data.media.url && (this.has.media = !0),
                    ...
                    (this.has.text || this.has.headline) && ((this._text = new de(this.data.text, { title: this.has.title, language: this.getLanguage(), autolink: this.data.autolink })), this._text.addDateText(this.getFormattedDate())),
                    this.has.text || this.has.headline || !this.has.media
                        ? this.has.headline && this.has.media && !this.has.text
                            ? (x(this._el.container, "tl-slide-media-only"), this._text.addTo(this._el.content), this._media.addTo(this._el.content))
                            : this.has.text && this.has.media
                            ? (this._text.addTo(this._el.content), this._media.addTo(this._el.content))
                            : (this.has.text || this.has.headline) && (x(this._el.container, "tl-slide-text-only"), this._text.addTo(this._el.content))
                        : (x(this._el.container, "tl-slide-media-only"), this._media.addTo(this._el.content)),
                    this.onLoaded();
            }
            _initEvents() {}
        ...
        class Ye {
            constructor(t, e, i, a) {
                a && this.setLanguage(a),
                    ...
                    "object" == typeof t ? ((this._el.container = t), (this.options.id = H(6, "tl"))) : ((this.options.id = t), (this._el.container = g(t))),
            ...
            updateDisplay(t, e, i, a) {
                ...
                for (var o = 0; o < this._slides.length; o++) this._slides[o].updateDisplay(this.options.width, this.options.height, n), this._slides[o].setPosition({ left: this.slide_spacing * o, top: 0 });
            ...
            goTo(t, e, i) {
                ...
                t < this._slides.length &&
                    ...
                    e
                        ...
                        : (this.animator = ot(this._el.slider_container, { left: -this.slide_spacing * t + "px", duration: this.options.duration, easing: this.options.ease, complete: this._onSlideChange(i) })),
            ...
            changeBackground(t) {
                ...
                t.color_value && "" != t.color_value
                    ? (e = L(t.color_value)) || (A("Invalid color value " + t.color_value), (e = this.options.default_bg_color))
            ...
            _initLayout() {
                x(this._el.container, "tl-storyslider"),
                    (this._nav.previous = new Ze({ title: "Previous", description: "description" }, { direction: "previous" }, this._el.container)),
                    (this._nav.next = new Ze({ title: "Next", description: "description" }, { direction: "next" }, this._el.container)),
                    ...
                    f &&
                        ((this._swipable = new Ue(this._el.slider_container_mask, this._el.slider_container, { enable: { x: !0, y: !1 }, snap: !0 })),
                        this._swipable.enable(),
                        (this._message = new Pt(this._el.container, { message_class: "tl-message-full", message_icon_class: "tl-icon-swipe-left" }, this.getLanguage())),
            ...
            _fireMouseEvent(t) {
                if (this._loaded) {
                    ...
                    (e = "mouseenter" === e ? "mouseover" : "mouseleave" === e ? "mouseout" : e),
                        this.hasEventListeners(e) && ("contextmenu" === e && ct.preventDefault(t), this.fire(e, { latlng: "something", layerPoint: "something else" }));
                }
            }
            _onLoaded() {
                this.fire("loaded", this.data);
        ...
        class Ve {
            constructor(t, e, i, a) {
                (this._el = { parent: {}, container: {}, button_forwardtoend: {}, button_backtostart: {}, button_zoomin: {}, button_zoomout: {}, arrow: {}, line: {}, coverbar: {}, grip: {} }),
                    (this.collapsed = !1),
                    (this._el.container = "object" == typeof t ? t : g(t)),
                    e && (this._el.parent = e),
                    (this.data = { visible_ticks_dates: {} }),
                    (this.options = { width: 600, height: 600, duration: 1e3, ease: at, menubar_default_y: 0 }),
                    (this.animator = {}),
                    this.setLanguage(a),
                    D(this.options, i),
                    this._initLayout(),
            ...
            _initEvents() {
                ct.addListener(this._el.button_forwardtoend, "click", this._onButtonForwardToEnd, this),
                    ct.addListener(this._el.button_backtostart, "click", this._onButtonBackToStart, this),
                    ct.addListener(this._el.button_zoomin, "click", this._onButtonZoomIn, this),
                    ct.addListener(this._el.button_zoomout, "click", this._onButtonZoomOut, this);
            }
            _updateDisplay(t, e, i) {
                t && (this.options.width = t), e && (this.options.height = e);
            }
        ...
        class Xe {
            constructor(t, e, i) {
                if (
                    ...
                    (this.message = new Pt(this._el.container, { message_class: "tl-message-full" })),
                ...
                D(this.options, i),
                    ...
                    this.options.debug && ((n = console.log), N.push(n)),
                    ...
                    this.options.is_embed && x(this._el.container, "tl-timeline-embed"),
                    this.options.is_full_embed && x(this._el.container, "tl-timeline-full-embed"),
            ...
            _initData(t) {
                "string" == typeof t
                    ? (async function (t, e) {
                          let i = null,
                              a = {};
                          if (("function" == typeof e ? (i = e) : "object" == typeof e && ((a = e), (i = e.callback), "function" == typeof a.callback && (i = a.callback)), !i))
                              throw new M("Second argument to makeConfig must be either a function or an object which includes a 'callback' property with a 'function' type value");
                          var s, n;
                          if (te(t)) {
                              try {
                              ...
                              if (((s = new Jt(n)), n.errors)) for (var o = 0; o < n.errors.length; o++) s.logError(n.errors[o]);
                              i(s);
                          } else
                              _t({
                                  url: t,
            ...
            _initLayout() {
                this.message.removeFrom(this._el.container),
                    ...
                    "top" == this.options.timenav_position
                        ? ((this._el.timenav = v("div", "tl-timenav", this._el.container)), (this._el.menubar = v("div", "tl-menubar", this._el.container)), (this._el.storyslider = v("div", "tl-storyslider", this._el.container)))
                        : ((this._el.storyslider = v("div", "tl-storyslider", this._el.container)), (this._el.timenav = v("div", "tl-timenav", this._el.container)), (this._el.menubar = v("div", "tl-menubar", this._el.container))),
                    ...
                    (this._timenav = new We(this._el.timenav, this.config, this.options, this.language)),
                    ...
                    (this._menubar = new Ve(this._el.menubar, this._el.container, this.options, this.getLanguage())),
            ...
            _updateDisplay(t, e, i) {
                ...
                i && (n = i),
                    ...
                    f && (this.options.layout = ((a = "portrait"), window.innerWidth > window.innerHeight && (a = "landscape"), Math.abs(window.orientation), a)),
                    h ? ((o += " tl-mobile"), (this.options.timenav_height = this._calculateTimeNavHeight(t, this.options.timenav_mobile_height_percentage))) : (this.options.timenav_height = this._calculateTimeNavHeight(t)),
                    ...
                    e
                        ? ((this._el.timenav.style.height = Math.ceil(this.options.timenav_height) + "px"),
                          ...
                          (this.animator_storyslider = ot(this._el.storyslider, { height: this.options.storyslider_height + "px", duration: n / 2, easing: it })),
                          this.animator_menubar && this.animator_menubar.stop(),
                          (this.animator_menubar = ot(this._el.menubar, { top: s + "px", duration: n / 2, easing: it })))
            ...
            _validateOptions() {
                for (var t = ["timenav_height", "timenav_height_min", "marker_height_min", "marker_width_min", "marker_padding", "start_at_slide", "slide_padding_lr"], e = 0; e < t.length; e++) {
                    var i = t[e],
                        a = this.options[i];
                    let s = !0;
                    "number" == typeof a ? (s = a == parseInt(a)) : "string" == typeof a && (s = a.match(/^\s*(\-?\d+)?\s*$/)), s || this.config.logError({ message_key: "invalid_integer_option", detail: i });
                }
            }
            _getSlideIndex(t) {
                if (this.config) {
            ...
            add(t) {
                ...
                this._storyslider.createSlide(a, this.config.title ? i + 1 : i), this._storyslider._updateDrawSlides(), this._timenav.createMarker(a, i), this._timenav._updateDrawTimeline(!1), this.fire("added", { unique_id: e });
            }
            remove(t) {
